...
print ('# Test 4 ')
print ('##################################')
print (Terms.getNamedInstance('Organization').rootDescriptors())
...
print ('# Test 7 ')
print ('##################################')
a = pathparser.tokenize("#"+me.id)
print(pathparser.selectAllDescriptors(a))

print ('##################################')
print ('# Test 8 ')
print ('##################################')
a = pathparser.tokenize("#"+me.id+">_configuration")
print(pathparser.selectAllDescriptors(a))

print ('##################################')
print ('# Test 9 ')
print ('##################################')
a = pathparser.tokenize("#"+me.id+">_configuration[_name=Boston]")
print(pathparser.selectAllDescriptors(a))

print ('##################################')
print ('# Test 10 ')
print ('##################################')
a = pathparser.tokenize("#"+me.id+">_configuration[_name=Boston]>_field:not([_name^=M])")
print(pathparser.selectAllDescriptors(a))
...
print ('##################################')
a = pathparser.tokenize("Organization>_name[_text=BYCF]")
