...
with transaction.atomic():
    ...
    newItem = parse('experience prompt[name="Beacon Academy Volunteer"]', context, ExperiencePrompt)[0]
    newItem.markDeleted(context)

    newItem = parse('experience prompt[name="Grade 7"]', context, ExperiencePrompt)[0]
    newItem.markDeleted(context)
