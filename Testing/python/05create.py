        ...
        'sites': [{'clientID': '2',
                  ...
                  'offerings': [{'clientID': '6',
                                ...
                                'sessions': [{'clientID': '8.1', 
                                              ...
                                              'inquiries': [{'user': 'user[email>text=michaelcrubenstein@gmail.com]'}, {'user': 'user[email>text=elizabethskavish@gmail.com]'}],
                                              'enrollments': [{'user': 'user[email>text=michaelcrubenstein@gmail.com]'}],
                                              'engagements': [{'user': 'user[email>text=michaelcrubenstein@gmail.com]'}],
