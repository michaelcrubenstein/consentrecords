...
var FlagData = (function() {
	...
	{
		var _this = this;
		var leftEnergy = this.springs.reduce(function(a, b)
			{
				if (b.left != _this)
					return a;
				else if (a == null)
		...
		var rightEnergy = this.springs.reduce(function(a, b)
			{
				if (b.right != _this)
					return a;
				else if (a == null)
		...
		return (leftEnergy ? leftEnergy.e : 0.0) +
			   (rightEnergy ? rightEnergy.e : 0.0);
	}
	...
	{
		var _this = this;
		var energies = this.springs.map(function(s) { return {energy: s.getEnergy(), spring: s}; });
		var leftEnergy = energies.reduce(function(a, b)
			{
				if (b.spring.left != _this)
					return a;
				else if (a == null)
					return b;
		...
		var rightEnergy = energies.reduce(function(a, b)
			{
				if (b.spring.right != _this)
					return a;
				else if (a == null)
					return b;
				else if (a.energy > b.energy)
		...
		return (leftEnergy ? leftEnergy.energy : 0.0) +
			   (rightEnergy ? rightEnergy.energy : 0.0);
	}
